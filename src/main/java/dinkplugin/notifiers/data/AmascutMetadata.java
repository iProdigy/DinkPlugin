...
public class AmascutMetadata implements Sanitizable {
    ...
    public static AmascutMetadata of(AmascutTracker tracker) {
        return new AmascutMetadata(tracker.getTeamSize(), tracker.getPartyMembers(), tracker.getPartyScore(), tracker.getRaidLevel(),
            tracker.getDamageDone(), tracker.getPetProbability(), tracker.getPurpleProbability());
    }
